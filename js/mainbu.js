...
item1 = new Item("Food", 4, 10, 0, 0, "item1", 0.96)
item2 = new Item("Tools", 6, 12, 0, 0, "item2", 0.92)
item3 = new Item("Medicine", 8, 15, 0, 0, "item3", 0.88)
item4 = new Item("Weapons", 12, 22, 0, 0, "item4", 0.85)
item5 = new Item("Armor", 15, 36, 0, 0, "item5", 0.80)

let items = [item1, item2, item3, item4, item5] //object array of all purchasable items
